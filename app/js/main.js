...
$('.input-file input[type=file]').on('change', function () {
  ...
  for (var i = 0; i < this.files.length; i++) {
    let new_file_input = '<div class="input-file-list-item">' + '<span class="input-file-list-name">' + this.files.item(i).name + '</span>' + '<a href="#" onclick="removeFilesItem(this); return false;" class="input-file-list-remove">+</a>' + '</div>';
...
// Убедитесь, что removeFilesItem доступна в глобальной области видимости
...
const swiperIntro = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.intro-swiper', {
  slidesPerView: 1,
  loop: true,
  autoplay: {
    delay: 3000,
...
swiperEquipmentCount.forEach(() => {
  const swiperEquipment = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](`.equipment-swiper-${num}`, {
    slidesPerView: 3,
    spaceBetween: 10,
    loop: false,
    navigation: {
...
const swiperBrands = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.brands-swiper', {
  slidesPerView: 5,
  spaceBetween: 10,
  loop: false,
  navigation: {
...
const swiperNews = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.news-swiper', {
  slidesPerView: 3,
  spaceBetween: 30,
  loop: false,
  navigation: {
...
const swiperImages = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.images-swiper', {
  slidesPerView: 1,
  spaceBetween: 20,
  loop: false,
  navigation: {
...
const swiperCatalogCategory = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.catalog-category-swiper', {
  slidesPerView: 4,
  spaceBetween: 15,
  loop: false,
  navigation: {
...
var swiperCardIntro = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.card-intro-swiper', {
  slidesPerView: 1,
  loop: false,
  spaceBetween: 16,
  watchSlidesProgress: true,
...
var swiperCardIntroThumbs = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.card-intro-swiper-thumbs', {
  spaceBetween: 15,
  slideToClickedSlide: true,
  loop: false,
  slidesPerView: 3,
